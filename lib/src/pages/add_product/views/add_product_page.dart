...
class AddProductPage extends GetView<ControllerAddProduct> {
  const AddProductPage({final Key? key}) : super(key: key);

  @override
  Widget build(final BuildContext context) => Scaffold(
        appBar: AppBar(
            title: Text(LocaleKeys.eshop_add_product_page_add_product.tr)),
